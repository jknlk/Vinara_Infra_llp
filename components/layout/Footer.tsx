  ...
  return (
    <footer className="bg-ink px-4 pb-4 pt-5 sm:px-6 lg:px-8">
      <div className="relative mx-auto w-full max-w-[1680px] overflow-hidden rounded-[2.5rem] border border-[#E3EAF4] bg-white">
        ...
        <div className="grid grid-cols-1 gap-4 px-8 pb-4 pt-6 sm:px-12 lg:grid-cols-2 lg:items-end">
          <div className="flex items-center gap-4">
            <Image src="/vinara-logo-transparent.png" alt="Vinara Infra LLP" width={64} height={64} className="h-16 w-auto" />
            <h2 className="text-display-m font-display leading-[0.95] text-ink">
              Let&rsquo;s
              <br />
        ...
        <div className="grid grid-cols-2 gap-x-8 gap-y-6 px-8 py-6 sm:grid-cols-4 sm:px-12">
          ...
          <div>
            ...
            <address className="mt-2 max-w-[26ch] text-caption not-italic leading-relaxed text-grey-500">
            ...
            <p className="mt-2 text-caption text-blue-600">{CONTACT.departments[1].contact}</p>
          </div>
        </div>

        <div className="border-t border-dashed border-[#E3EAF4]" />

        <div className="flex flex-col items-start justify-between gap-2 px-8 py-3 text-caption text-grey-500 sm:flex-row sm:items-center sm:px-12">
